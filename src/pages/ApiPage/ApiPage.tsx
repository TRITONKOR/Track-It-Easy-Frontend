    ...
    return (
        <div className={styles['api-page']}>
            <div className={styles['api-content']}>
                <h1 className={styles['api-title']}>Публічне API Track It Easy</h1>
                <p className={styles['api-desc']}>
                    Ви можете інтегруватися з нашим сервісом через REST API для відстеження посилок,
                    реєстрації користувачів, авторизації та інших дій. Всі публічні ендпоінти
                    описані у Swagger-документації.
                </p>
                ...
                <div className={styles['api-actions-row']}>
                    ...
                    {user && (
                        <button
                            className={styles['api-btn'] + ' ' + styles['api-key-btn']}
                ...
                {user && (
                    <div className={styles['api-key-block']}>
                        <label className={styles['api-key-label']}>API ключ</label>
                        ...
                        {error && <div className={styles['api-key-error']}>{error}</div>}
                    </div>
                )}
            </div>
        </div>
